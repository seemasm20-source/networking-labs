...
|---|-------|-------|-----|------|
| 1 | PCs could not communicate across LANs | Wrong default gateway on PCs | Set correct gateway on all PCs |https://github.com/seemasm20-source/networking-labs/blob/main/troubleshooting/wrong-gateway-issue.md |
